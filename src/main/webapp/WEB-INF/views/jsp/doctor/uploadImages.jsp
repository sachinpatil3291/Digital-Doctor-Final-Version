...
<body>
	 <spring:url value="/doctor/upload/image" var="doctorActionUrl" />
	 <form:form method="post" modelAttribute="fileUpload" enctype="multipart/form-data" action="${doctorActionUrl}" >
